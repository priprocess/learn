...
2. **Tour** the repo: a self-contained HTML viewer (diagram + clickable checkpoints)
   opens in your browser while Claude narrates and answers questions in the terminal.
   Progress is per-person and resumable.
...
The map is committed, shared documentation. Per-person progress
...
- `scripts/build-view.cjs` — turns `map.md` + progress into one self-contained
